...
# Choices: yolo11n.pt (fastest/smallest) → yolo11x.pt (largest/most accurate)
...
# 2) Helper: draw rectangle + label background
def draw_box_with_label(frame, x1, y1, x2, y2, label, color=(0, 255, 0), thickness=2):
    ...
    cv2.putText(frame, label, (x1 + 4, y1 - base - 3), font,
                font_scale, (255, 255, 255), text_th, cv2.LINE_AA)

# 3) Open the webcam (0 = default camera)
